...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/Toxic-Noob/Bomber-Girgiti/main/more/.version").text
    except:
    ...
    os.system("cd .. && rm -rf Bomber-Girgiti && git clone https://github.com/Toxic-Noob/Bomber-Girgiti > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd Bomber-girgiti && python GG.py")

print('''
\033[1;92m Recoded By Team Toxic
GirGiTi
Telegram:https://t.me/girgitigamingyt
For Help FB Page-Girgiti Gaming\033[0m
''')
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mBomber-Girgiti\n")
        time.sleep(0.6)
